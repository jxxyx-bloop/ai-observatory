...
`ไม่ใช้โทเคนเลย` · `ไม่ต้องมีบัญชี` · `ไม่มีข้อมูลออกจากเครื่อง`
...
> **สูง** — คุณกำลังจ่ายราคาช่วงพีคทั้งที่ไม่จำเป็น · **≈ 34 ดอลลาร์/เดือน**<br>
...
> **กลาง** — คอนเท็กซ์ถูกสร้างใหม่ ไม่ได้ถูกใช้ซ้ำ · **≈ 61 ดอลลาร์/เดือน**<br>
...
| agent เขียนบันทึกทุกเซสชันไว้อยู่แล้ว เราอ่านไฟล์เหล่านั้นตรงที่มันอยู่ | โทเคน แคช ช่วงเวลา และต้นทุน — คิดตามอัตราที่มีผลจริงตอนงานนั้นรัน | รายการสิ่งที่ควรเปลี่ยน จัดลำดับไว้ พร้อมหลักฐานและมูลค่าต่อเดือน |
