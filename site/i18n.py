...
STRINGS["en"] = {
    ...
    "how_1_t": "Read",
    "how_1_d": "Your agent writes a transcript for every session. We parse those "
               "files, on disk, where they already are.",
    "how_2_t": "Measure",
...
STRINGS["zh-Hans"] = {
    ...
    "how_h2": "三步，约一秒钟。",
    "how_1_t": "读取",
    "how_1_d": "Agent 会为每次会话写下完整记录。我们就地解析这些文件。",
    "how_2_t": "计量",
...
STRINGS["zh-Hant"] = {
    ...
    "how_h2": "三個步驟，約一秒。",
    "how_1_t": "讀取",
    "how_1_d": "Agent 會為每次 session 寫下完整記錄。我們就地解析這些檔案。",
    "how_2_t": "計量",
...
STRINGS["ja"] = {
    ...
    "how_h2": "3ステップ、約1秒。",
    "how_1_t": "読む",
    "how_1_d": "エージェントはセッションごとに記録を残しています。その場にあるファイルをそのまま解析します。",
    "how_2_t": "測る",
...
STRINGS["ko"] = {
    ...
    "how_h2": "세 단계, 약 1초.",
    "how_1_t": "읽기",
    "how_1_d": "에이전트는 세션마다 기록을 남깁니다. 그 파일을 있는 자리에서 그대로 해석합니다.",
    "how_2_t": "측정",
...
STRINGS["hi"] = {
    ...
    "how_1_t": "पढ़ना",
    "how_1_d": "आपका एजेंट हर सेशन का रिकॉर्ड लिखता है। हम वही फ़ाइलें, जहाँ हैं वहीं, पढ़ते हैं।",
    "how_2_t": "मापना",
...
STRINGS["id"] = {
    ...
    "how_1_t": "Baca",
    "how_1_d": "Agent Anda menulis transkrip untuk tiap sesi. Kami membaca berkas itu di tempatnya.",
    "how_2_t": "Ukur",
...
STRINGS["vi"] = {
    ...
    "how_1_t": "Đọc",
    "how_1_d": "Agent ghi lại toàn bộ mỗi phiên làm việc. Chúng tôi đọc chính các tệp đó, ngay tại chỗ.",
    "how_2_t": "Đo",
...
STRINGS["th"] = {
    ...
    "how_1_t": "อ่าน",
    "how_1_d": "agent เขียนบันทึกทุกเซสชันไว้อยู่แล้ว เราอ่านไฟล์เหล่านั้นตรงที่มันอยู่",
    "how_2_t": "วัด",
...
STRINGS["ms"] = {
    ...
    "how_1_t": "Baca",
    "how_1_d": "Agent anda menulis transkrip bagi setiap sesi. Kami membaca fail itu di tempatnya.",
    "how_2_t": "Ukur",
...
STRINGS["fil"] = {
    ...
    "how_1_t": "Basahin",
    "how_1_d": "May transcript ang agent mo sa bawat session. Binabasa namin ang mga file na iyon kung nasaan sila.",
    "how_2_t": "Sukatin",
...
STRINGS["pt-BR"] = {
    ...
    "how_1_t": "Ler",
    "how_1_d": "Seu agente grava a transcrição de cada sessão. A gente lê esses arquivos onde eles já estão.",
    "how_2_t": "Medir",
...
STRINGS["es"] = {
    ...
    "how_1_t": "Leer",
    "how_1_d": "Tu agente escribe una transcripción de cada sesión. Leemos esos archivos donde ya están.",
    "how_2_t": "Medir",
